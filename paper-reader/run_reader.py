...
from reader_quality import (
    browser_record_has_fulltext,
    looks_like_full_article,
    page_is_cookie_wall,
    pdf_text_quality,
    publisher_page_blocked,
    snapshot_quality,
    summary_mode_indicates_fulltext,
)
from reader_pdf_text import (
    extract_pdf_text_from_bytes as _extract_pdf_text_from_bytes_impl,
    extract_pdf_text_with_mineru as _extract_pdf_text_with_mineru_impl,
    extract_pdf_text_with_pdftotext as _extract_pdf_text_with_pdftotext_impl,
    paper_reader_mineru_cleanup_enabled as _paper_reader_mineru_cleanup_enabled_impl,
    upgrade_record_with_mineru_text as _upgrade_record_with_mineru_text_impl,
)
from reader_generation import (
    SECTION_KEYS,
    _repair_english_fields,
    build_fallback_sections,
    build_generation_prompt,
    build_rewrite_prompt,
    needs_chinese_rewrite,
    parse_sections_output,
)
from reader_text import (
    ...
    parse_doi_candidate,
    render_figure_takeaways_text,
    render_note_section_text,
    safe_filename,
    sanitize_model_text,
    sentence_chunks,
    text_or_empty,
...
def extract_pdf_text_with_pdftotext(path: Path) -> str:
    return _extract_pdf_text_with_pdftotext_impl(path, find_tool)


def extract_pdf_text_with_mineru(pdf_path: Path, identifier: str = "") -> dict:
    return _extract_pdf_text_with_mineru_impl(
        pdf_path,
        identifier,
        find_tool_func=find_tool,
        pdf_save_dir=PDF_SAVE_DIR,
    )


def upgrade_record_with_mineru_text(record: dict, identifier: str = "") -> dict:
    return _upgrade_record_with_mineru_text_impl(
        record,
        identifier,
        find_tool_func=find_tool,
        pdf_save_dir=PDF_SAVE_DIR,
...
def extract_pdf_text_from_bytes(data: bytes, temp_pdf_path: Path | None = None) -> str:
    return _extract_pdf_text_from_bytes_impl(
        data,
        temp_pdf_path,
        pdftotext_func=extract_pdf_text_with_pdftotext,
    )


def _paper_reader_mineru_cleanup_enabled() -> bool:
    return _paper_reader_mineru_cleanup_enabled_impl()
