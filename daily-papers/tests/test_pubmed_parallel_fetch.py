...
用法
----
    python tests/test_pubmed_parallel_fetch.py --date 2025-08-26 --retmax 500
    python tests/test_pubmed_parallel_fetch.py --date 2025-08-26 --retmax 2000 --workers 8
    python tests/test_pubmed_parallel_fetch.py --date 2025-08-26 --retmax 500 --serial-only
"""
